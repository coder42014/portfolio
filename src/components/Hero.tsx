  ...
  return (
    <section id="home" className="min-h-screen relative overflow-hidden">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button 
                  ...
                  className="border border-white/20 text-white px-8 py-3 rounded-xl font-medium hover:bg-white/10 transition-all duration-300"
                >
                  View Projects
                </button>
              </div>
              ...
              <div className="flex items-center gap-6">
                <a href="mailto:theyashsisodiya@gmail.com" className="text-gray-400 hover:text-white transition-colors duration-300">
                  <Mail size={20} />
                </a>
                <a href="tel:+917389022061" className="text-gray-400 hover:text-white transition-colors duration-300">
                  <Phone size={20} />
                </a>
                <a href="https://github.com/theyashsisodiya" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300">
                  <Github size={20} />
                </a>
                <a href="https://linkedin.com/in/theyashsisodiya" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300">
                  <Linkedin size={20} />
                </a>
              </div>
            </div>
            ...
            <div className="lg:flex hidden items-center justify-center">
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-4 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 text-center col-span-2">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20">
        <button 
          onClick={scrollToAbout}
          className="text-white/60 hover:text-white animate-bounce transition-colors duration-300"
        >
          <ArrowDown size={24} />
        </button>
      </div>
